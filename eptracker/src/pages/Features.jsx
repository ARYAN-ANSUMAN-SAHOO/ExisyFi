                        ...
                        <div className="feature-card">
                            ...
                            <div className="feature-icon">
                                <svg width="64" height="64" viewBox="0 0 24 24" fill="none" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                                    ...
                                    <circle cx="17" cy="6" r="3" stroke="#7C3AED" />
                                    <path d="M17 3v1M17 9v1M14 6h1M20 6h1" stroke="#7C3AED" />
                                </svg>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="feature-card">
                            ...
                            <div className="feature-icon">
                                <svg width="64" height="64" viewBox="0 0 24 24" fill="none" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                                    ...
                                    <text x="10" y="13.5" fontSize="5" fill="#7C3AED" fontWeight="bold">$</text>
                                    <text x="15" y="10" fontSize="4" fill="#0ea5e9" fontWeight="bold">€</text>
                                    <text x="5" y="16" fontSize="4" fill="#7C3AED" fontWeight="bold">£</text>
                                </svg>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="feature-card">
                            ...
                            <div className="feature-icon">
                                <svg width="64" height="64" viewBox="0 0 24 24" fill="none" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                                    ...
                                    <text x="9" y="17.5" fontSize="4" fill="#A78BFA" fontWeight="bold">AI</text>
                                </svg>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="feature-card">
                            ...
                            <div className="feature-icon">
                                <svg width="64" height="64" viewBox="0 0 24 24" fill="none" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                                    ...
                                    <text x="4.5" y="11" fontSize="4.5" fill="#A78BFA" fontWeight="bold">PDF</text>
                                    {/* XLS doc behind */}
                                    <rect x="9" y="7" width="10" height="12" rx="1" stroke="url(#fg3)" />
                                    <text x="10.5" y="15" fontSize="4" fill="#7C3AED" fontWeight="bold">XLS</text>
                                    {/* Download arrow */}
                                    <circle cx="17" cy="19" r="3" stroke="#7C3AED" />
                                    <path d="M17 17v2l1 1" stroke="#7C3AED" />
                                </svg>
                            </div>
                        </div>
                    </div>
